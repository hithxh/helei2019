...
namespace GeneralTSALNS
{
    class AEOSSProblem:problem
    {
        ...
        public void LoadInstance(string Distribution, string SuperOrderNum)
        {
            ...
            //Read tasks
            StreamReader TaskReader = new StreamReader(@"...\...\...\...\AEOSS\instances\" + Distribution + "_Task_" + SuperOrderNum + ".txt");
            ...
            //Read time windows
            int CountId = 0;
            StreamReader sr = new StreamReader(@"...\...\...\...\AEOSS\instances\" + Distribution + "_TimeWindow_" + SuperOrderNum + ".txt");
